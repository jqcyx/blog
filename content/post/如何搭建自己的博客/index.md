...
接下来如果你觉得我推荐的主题不好，可以自行去[这里](https://themes.gohugo.io/)寻找一个肥美的主题，但是接下来的教程都没用了。而且 Stack 可是第二大主题。
...
下载并安装 [Go](https://golang.google.cn/dl/)。
...
打开 Cloudflare，选择 Workers 和 Pages，创建应用程序，开始使用，导入现有 Git 存储库，添加 GitHub 账户，然后选择你的存储库，框架预设选 hugo，保存并部署。
